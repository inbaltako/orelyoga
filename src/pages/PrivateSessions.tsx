...
export const PrivateSessions: React.FC = () => {
  ...
  // Limit booking to 2 months in advance (current month + 2 months ahead = 3 months total)
  ...
  const currentDayData = useMemo(() => {
    ...
    const dayOfWeek = new Date(viewYear, viewMonth, selectedDayNumber).getDay();
  ...
  }, [selectedDayNumber, viewYear, viewMonth]);
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 gap-6">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={() => setCurrentMonthIndex((prev) => (prev < 2 ? prev + 1 : prev))}
                    ...
                    <button
                      ...
                      className={`aspect-square p-2 sm:p-3 flex flex-col items-center justify-between rounded-xl transition-all relative ${
                        isSelected
                          ...
                          : 'bg-surface/50 text-on-surface-variant/35 cursor-not-allowed opacity-40'
                      }`}
                    >
